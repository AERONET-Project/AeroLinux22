...
//print the list of serial ports
    printf("1st time checking serial ports\n");
    system("python -m serial.tools.list_ports -v ");
...
//print the list of serial ports
    printf("2nd time checking serial ports\n");
    system("python -m serial.tools.list_ports -v ");
...
{
    printf ("Do update\n");
    sprintf (com_line,"sh %s/aerolinux1/controls/updater_connected.sh", homedir);
